...
function ApprovedListingTable() {
          ...
          const dataSource =
                    listData?.data?.filter(item => item.status === "ACTIVE")
                              .map((list, index) => ({
                                                                                ...
                                                                                <div className="space-y-4">
                                                                                          <div className="grid grid-cols-2 gap-4">
                                                                                                    <div>
                                                                                                              ...
                                                                                                              <p className="mt-1 bg-green-50 text-green-700 px-3 py-1 rounded">
                                                                                                    ...
                                                                                                    <div>
                                                                                                              ...
                                                                                                              <p className="mt-1 bg-green-50 text-green-700 px-3 py-1 rounded truncate">
...
export default ApprovedListingTable;