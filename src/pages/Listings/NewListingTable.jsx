...
function NewListingTable() {
          ...
          const dataSource =
                    listData?.data?.filter(item => item.status === "PENDING")
                              .map((list, index) => ({
                                                                                ...
                                                                                <div className="space-y-6">
                                                                                          <div>
                                                                                                    ...
                                                                                                    <div className="flex items-center mt-2">
                                                                                                              ...
                                                                                                              <p className="ml-2 text-yellow-500">Pending Approval</p>
                                                                                                    </div>
                                                                                          </div>
                                                                                          ...
                                                                                          <div className="space-y-4">
                                                                                                    <div className="grid grid-cols-2 gap-4">
                                                                                                              <div>
                                                                                                                        ...
                                                                                                                        <p className="mt-1 bg-yellow-50 text-yellow-700 px-3 py-1 rounded">
                                                                                                              ...
                                                                                                              <div>
                                                                                                                        ...
                                                                                                                        <p className="mt-1 bg-yellow-50 text-yellow-700 px-3 py-1 rounded truncate">
