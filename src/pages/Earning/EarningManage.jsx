...
function EarningManage() {
  ...
  return (
    <div>
      <div className="relative w-full flex z-[999] overflow-hidden h-[250px] items-center justify-between bg-gradient-to-tr from-white via-white to-[#21c45d]/70 p-10 rounded-xl">
        <div className="absolute top-0 -z-1 left-32 w-full h-full">
          <img className="w-[80%] h-full object-cover" src={earn} alt="" />
        </div>
        <div className="flex flex-col items-start">
          <div className="bg-[#21c45d] rounded-md p-4 ">
            <FaDollarSign />
          </div>
          <h2 className="text-xl font-semibold !mt-5 text-gray-800 leading-none">
            Total Earnings
          </h2>
          <h1 className="text-3xl leading-none text-[#21c45d]">{dashboardData?.total_earning}</h1>
        </div>
      </div>
    </div>
  );
